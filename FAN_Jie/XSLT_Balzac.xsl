...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
            ...
            <html lang="fr">
                ...
                <body>
                    ...
                    <div style="text-align: center;">
                        <img src="vieille_fille_vignette.jpg" alt="vieille fille vignette"/>
                    </div>
    ...
    <xsl:template name="index_pers">
        <xsl:result-document href="{$index_pers}">
            <html lang="fr">
                <xsl:copy-of select="$header"/>
                <body>
                    <xsl:attribute name="style">
    ...
    <xsl:template name="index_place">
        <xsl:result-document href="{$index_place}">
            <html lang="fr">
                <xsl:copy-of select="$header"/>
                <body>
                    <xsl:attribute name="style">
    ...
    <xsl:template name="index_org">
        <xsl:result-document href="{$index_org}">
            <html lang="fr">
                <xsl:copy-of select="$header"/>
                <body>
                    <xsl:attribute name="style">
