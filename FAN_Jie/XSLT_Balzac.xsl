...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="home">
        <xsl:value-of select="concat('html/la_vieille_fille_home','.html')"/>
    </xsl:variable>
    <xsl:variable name="chap1">
        <xsl:value-of select="concat('html/la_vieille_fille_chap1','.html')"/>
    </xsl:variable>
    <xsl:variable name="index_pers">
        <xsl:value-of select="concat('html/index_pers','.html')"/>
    </xsl:variable>
    <xsl:variable name="index_place">
        <xsl:value-of select="concat('html/index_place','.html')"/>
    </xsl:variable>
    <xsl:variable name="index_org">
        <xsl:value-of select="concat('html/index_org','.html')"/>
    </xsl:variable>
    ...
    <xsl:variable name="return_index_pers">
        <i><a href="{concat('./', $index_pers)}">Index des noms de personnes</a></i>
    </xsl:variable>
    
    <xsl:variable name="return_index_place">
        <i><a href="{concat('./', $index_place)}">Index des noms de lieux</a></i>
    </xsl:variable>
    
    <xsl:variable name="return_index_org">
        <i><a href="{concat('./', $index_org)}">Index des noms d'organisations</a></i>
    </xsl:variable>
